(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('simple-uuidv4')) :
  typeof define === 'function' && define.amd ? define(['exports', 'simple-uuidv4'], factory) :
  ...
  var calcLeftWidthPercent = function (evt, ele) {
    ...
    var rightLeft = pageX - offsetLeft;
  ...
  var script$4 = {
    ...
    mounted: function mounted(){
      ...
      vue.$refs.imgurl.onload = function () {
      ...
      vue.$refs.canvas.onmousedown = function (evt) {
        // console.log('onmousedown', evt, vue.$refs);
        var ref = vue.$refs.canvas;
        var clientWidth = ref.clientWidth;
        var clientHeight = ref.clientHeight;
        var rect = {clientWidth: clientWidth, offsetLeft:0, clientHeight: clientHeight, offsetTop:0};
      ...
      vue.$refs.canvas.onmousemove = function (evt) {
        if(!vue.clipperBase.start) { return void 0; }
        // console.log('onmousemove', evt);
        vue.clipperBase.end = evt;
        vue.drawRect();
      };
      vue.$refs.canvas.onmouseup = function (evt) {
      ...
      vue.$refs.canvas.onmouseleave = function (evt) {
        //console.log('onmouseleave', evt);
        vue.clipperBase.leave = true;
        return vue.clearRect();
      };
      vue.$refs.canvas.onmouseenter = function (evt) {
    ...
    methods:{
      updateClipper: function updateClipper(){
      },
      updateCanvas: function updateCanvas() {
        var vue = this;
        var ctx2d = vue.clipperBase.ctx2d;
      ...
      beginDrawRect: function beginDrawRect(){
        var vue = this;
        var ctx2d = vue.clipperBase.ctx2d;
        ctx2d.save();
      ...
      drawRect: function drawRect(){
        ...
        var clientWidth = vue.$refs.canvas.clientWidth || 1;
        var clientHeight = vue.$refs.canvas.clientHeight || 1;
        var x = Math.round((vue.clipperBase.start.layerX) * vue.canvas.width / clientWidth);
        var y = Math.round((vue.clipperBase.start.layerY) * vue.canvas.height/ clientHeight);
        var wx = Math.round((vue.clipperBase.end.layerX - vue.clipperBase.start.layerX) * vue.canvas.width / clientWidth);
        var wy = Math.round((vue.clipperBase.end.layerY - vue.clipperBase.start.layerY) * vue.canvas.height/ clientHeight);
        var startX = Math.min(x, x+wx);
        var startY = Math.min(y, y+wy);
        var drawX = Math.abs(wx);
        var drawY = Math.abs(wy);
        vue.clipperBase.clip = {startX: startX,startY: startY, drawX: drawX, drawY: drawY};
      ...
      endDrawRect: function endDrawRect(){
        var vue = this;
        // console.log('end draRect', vue.clipperBase);
        if(!vue.clipperBase.clip) { return; }
        var ref = vue.clipperBase.clip;
        var startX = ref.startX;
        var startY = ref.startY;
        var drawX = ref.drawX;
        var drawY = ref.drawY;
        try{
          var imageData = vue.offcanvas.ctx.getImageData(startX, startY, drawX, drawY);
      ...
      localLoadImage: function localLoadImage(url) {
        var vue = this;
        vue.localUrl = url;
  ...
  var __vue_render__$4 = function() {
    ...
    return _c(
      "div",
      { staticClass: "image-clipper", attrs: { square: _vm.square } },
      [
        _c("img", {
          ref: "imgurl",
          staticClass: "image-clipper-item",
          attrs: { src: _vm.localUrl }
        }),
        _vm._v(" "),
        _c("canvas", {
          ref: "canvas",
          staticClass: "image-clipper-item",
          attrs: { width: _vm.canvas.width, height: _vm.canvas.height }
        })
      ]
    )
  };
  ...
  var index$1 = /*#__PURE__*/Object.freeze({
    ...
    ImageClipper: __vue_component__$4
  });
  ...
  exports.mapUtils = map_utils;
  exports.waybill = waybill;
  exports.widgets = index$1;
