(function (global, factory) {
  ...
  __vue_render__$2._withStripped = true;
    ...
    var __vue_inject_styles__$2 = function (inject) {
      if (!inject) { return }
      inject("data-v-9e60f638_0", { source: "\ndiv.log[data-v-9e60f638] {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n", map: {"version":3,"sources":["/Users/liuhr/workspace/comp/dayi/admin-widget/src/waybill/components/log.vue"],"names":[],"mappings":";AA0BA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;AACA","file":"log.vue","sourcesContent":["<template>\n<div class=\"log\">\n  <div>className:{{className}}</div>\n  <div>logPoint:{{logPoint}}</div>\n  <div>unloadPoint:{{unloadPoint}}</div>\n  <div>loadRule:{{loadRule}}</div>\n  <div>unloadRule:{{unloadRule}}</div>\n  <div>amap:{{amap}}</div>\n</div>\n</template>\n\n<script>\nexport default {\n  name:'log',\n  props:{\n    className:String,\n    loadPoint:Array,\n    unloadPoint:Array,\n    loadRule:Function,\n    unloadRule:Function,\n    amap:Object,\n  },\n}\n</script>\n\n<style scoped>\ndiv.log {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n</style>"]}, media: undefined });

    };
    /* scoped */
    var __vue_scope_id__$2 = "data-v-9e60f638";
    /* module identifier */
  ...
  var clearPartMakerList = function (map, container, pathList) {
    if ( map === void 0 ) map={};
    if ( pathList === void 0 ) pathList=[];

    pathList.filter(function (ele) {
  ...
  var drawPassPointMarker = function (map, trackEle, amap, container, vue, still) {
    ...
    var poinIcon = new amap.Icon({
      image: loadPointIconSetting.pass[trackEle.origin],
      size: new amap.Size(12, 12),
      imageSize: new amap.Size(12, 12),
    });
    var poinIconOver = new amap.Icon({
  ...
  var drawTrackPassPoint = function (vue, trackPartList) {
    return confirmAmap(vue).then(function (ref) {
      var amap = ref[0];
      var container = ref[1];
      ...
      var passPointList = trackPartList.map(function (trackPart, idx) {
        ...
        var pathLength = amap.GeometryUtil.distanceOfLine(validTrack.map(function (ele) { return [ele.lng, ele.lat]; }));
        var points = Math.floor(pathLength / (resolution * 30)) || 1;
        var trackLength = validTrack.length;
        var step = Math.floor(trackLength / points) || 1;
        drawTrack = validTrack.filter(function (ele, idx) { return idx % step == 0; });
        return drawTrack.map(function (trackEle) {
          var newTrackMarker = drawPassPointMarker(markerMap, trackEle, amap, container, vue);
    ...
    methods: {
      ...
      drawTrackAll: function drawTrackAll() {
        ...
        renderTheRoute(vue).then(function (ok) {
          ...
          var endPoint = ref[1];
          return Promise.all([renderTheAction(vue, startPoint, endPoint), startPoint, endPoint]);
        }).then(function (ref) {
          var ok = ref[0];
      ...
      drawTrackPath: function drawTrackPath(startPoint, endPoint) {
        ...
        var drawTrackPathHandle = function (pathArray, pathColor, category) {
          ...
          return getValidPathArray(vue, pathArray).then(function (paths) {
            ...
            drawTrackPassPoint(vue, trackParts);
          });
        };
