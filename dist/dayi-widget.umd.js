  ...
  var script$4 = {
    ...
    mounted: function mounted(){
      ...
      vue.$refs.canvas.onmousedown = function (evt) {
        ...
        var accumulateOffset = function (ele, base) {
          if ( base === void 0 ) base=rect;
