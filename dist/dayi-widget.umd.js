    ...
    return confirmAmap(vue).then(function (ref) {
      ...
      var passPointList = trackPartList.map(function (trackPart, idx) {
        ...
        case 'everypass':
          ...
          break;
        default:
          var px = vue.pointDensity > 1 ? vue.pointDensity : 30;
        ...
        drawTrack = validTrack.filter(function (ele, idx) { return idx % step == 0 || idx == lastIndex || ele.isDangerous; });
